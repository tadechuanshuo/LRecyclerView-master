...
public class NestRecylcerviewActivity extends AppCompatActivity{
    ...
    private class DataAdapter extends ListBaseAdapter<ItemModel> {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(NestRecylcerviewActivity.this, 100) * (mGoodsList.size() >= 3 ? (mGoodsList.size() % 3 > 0 ? (mGoodsList.size() / 3 + 1) : (mGoodsList.size()/3)) : 1));
