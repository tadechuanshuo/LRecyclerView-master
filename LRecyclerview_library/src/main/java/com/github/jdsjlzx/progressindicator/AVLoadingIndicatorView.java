...
import com.github.jdsjlzx.progressindicator.indicator.BallHorizontalRotatyIndicator;
...
public class AVLoadingIndicatorView extends View{
    ...
    public static final int TwoBallTransition=28;
    ...
    private void applyIndicator(){
        switch (mIndicatorId){
            ...
            case SemiCircleSpin:
                ...
                break;
            case TwoBallTransition:
                mIndicatorController=new BallHorizontalRotatyIndicator();
                bringToFront();
        }
